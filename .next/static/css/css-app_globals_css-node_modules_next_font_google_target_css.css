...
.bg-\[radial-gradient\(circle_at_20\%_50\%\2c rgba\(59\2c 130\2c 246\2c 0\.1\)\2c transparent_50\%\)\] {
  background-image: radial-gradient(circle at 20% 50%,rgba(59,130,246,0.1),transparent 50%);
}
.bg-\[radial-gradient\(circle_at_80\%_80\%\2c rgba\(99\2c 102\2c 241\2c 0\.1\)\2c transparent_50\%\)\] {
  background-image: radial-gradient(circle at 80% 80%,rgba(99,102,241,0.1),transparent 50%);
}
.bg-gradient-to-br {
...
.shadow-glass-lg {
  --tw-shadow: 0 20px 60px 0 rgba(31, 38, 135, 0.3);
...
:root {
  ...
  --primary-blue-light: 59, 130, 246;
  --primary-blue-dark: 29, 78, 216;
}
